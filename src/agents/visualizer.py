...
<style>
  ...
  #site-title h1 {
    margin: 0; font-size: 18px; color: #ecf0f1; font-weight: 700; white-space: nowrap;
  }
  #site-title .disclaimer {
    font-size: 12px; color: #e74c3c; font-weight: 600; white-space: nowrap;
  }
  #site-title .sub {
    font-size: 12px; color: #7f8c8d;
  }
  /* push the vis canvas below the title bar */
  #mynetwork { margin-top: 48px !important; height: calc(92vh - 48px) !important; }
  #sna-legend { top: 60px !important; }
...
<div id="site-title">
  <h1>Epstein Network — Social Graph</h1>
  <span class="disclaimer">&#9888; NOT REAL DATA</span>
  <span class="sub">All entities and relationships were generated by Claude AI from its training knowledge — not extracted from actual court documents. This graph is incomplete and may contain errors.</span>
</div>
